...
class ListCostum extends StatefulWidget {
  final List<Flight> listFlight;
  final double? opacity;
  const ListCostum({super.key, required this.listFlight, this.opacity});

  @override
  State<ListCostum> createState() => _ListCostumState();
}

class _ListCostumState extends State<ListCostum> {
  @override
  ...
  Widget elementFlight({required Flight flight}) => Dismissible(
        ...
        child: InkWell(
          ...
          child: ListTile(
            title: AutoSizeText(
              "${flight.aiportDeparture.nameAriport} - ${flight.airportArrival.nameAriport}",
            ...
            subtitle: Text(
              _getTime(
                  startFlight: flight.aiportDeparture.estimateArrival,
